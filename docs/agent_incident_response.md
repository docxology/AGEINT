...
- Prepare: define scope, tool permissions, logs, escalation roles, and stop
  conditions.
- Detect: identify anomalous output, policy drift, source laundering, data
  exposure, or unsafe tool requests in synthetic tickets.
- Contain: pause the workflow, revoke tool access, preserve records, and route
  to human review.
- Recover: restore a known-safe prompt, dataset, tool profile, or rubric state.
...
containment, exploitation, credential use, and unsafe cyber-physical action.
