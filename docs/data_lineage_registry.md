...
## Registry objects: source, dataset, prompt, output, and handoff records
...
## Source rules: provenance anchors and traceability requirements
...
## Safety boundary: retain review evidence without exposing sensitive data
