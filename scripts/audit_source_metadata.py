#!/usr/bin/env python3
"""Write and report AGEINT source-anchor metadata coverage."""
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--write", action="store_true", help="Write output/reports/source_metadata.{json,md}.")
    return parser
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.write:
        json_path, md_path, report = write_source_metadata(PROJECT_ROOT)
    else:
    ...
    if args.format == "json":
        ...
        print(render_source_metadata_markdown(report), end="")
