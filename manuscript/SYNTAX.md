...
- Topic-lesson bodies include a **Cross-links** line with the unit module map `[@fig:part-…-module-map]`, module overview `[@sec:chapter-…]`, and atlas `[@sec:curriculum_orientation]`.
