...
def _render_visual_accessibility_contract(output: Path, spec: FigureSpec) -> None:
    rows = [
        ...
        ("Long description", ("equivalent content", "relationships and limits", "long_description", "70-word gate")),
    ...
    draw_control_matrix(output, spec.title, rows, ("Guidance", "Reader value", "Registry field", "Verifier"), "#bfdbfe", "#dcfce7")
