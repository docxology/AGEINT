...
_INTELLIGENCE_PROFILES_CORE: Final[tuple[IntelligenceProfile, ...]] = (
    IntelligenceProfile(
        ...
        match_terms=("nature of intelligence", "intelligence community architectures", "dissemination", "classification", "marking", "information architecture"),
        anchor_keys=(
        ...
        conceptual_focus=(
            "treating the intelligence cycle as a governed information system whose collection, processing, analysis, dissemination, evaluation, marking, and records obligations stay explicit"
        ),
        method_stack=(
            "cycle mapping, priority-to-product traceability, data-lifecycle mapping, classification vocabulary review, dissemination-caveat audit, customer feedback, and oversight checkpointing"
        ),
        composability_contract=("requirements, data provenance, analytic judgments, markings, dissemination permissions, records obligations, and feedback remain separable artifacts"),
        failure_modes=("cycle theater, undocumented dissemination, classification drift, unclear release authority, stale records assumptions, and feedback loops that hide bias"),
        safety_boundary=("cycle and marking material remains public-source and educational; it never handles classified content, live release decisions, or source-method exposure"),
        source_pack_ids=("odni_governance_directives", "odni_disclosure_and_tearlines", "ic_current_threat_baseline"),
    ),
    IntelligenceProfile(
        identifier="analytic_tradecraft",
        title="Analytic Tradecraft and Source Integrity",
        match_terms=("analysis", "analytic", "intelligence community", "tradecraft", "epistemic", "structured", "historical"),
        anchor_keys=(
            "official_odni_icd_203",
        ...
        conceptual_focus=(
            "turning uncertainty into reviewable judgment through sourcing, alternatives, separated likelihood and confidence language, warning indicators, and explicit analytic lineage"
        ),
        method_stack=(
        ...
        composability_contract=("every agent output must preserve evidence, assumptions, judgments, likelihood, confidence, dissent, empirical limits, and change history as separable fields"),
        failure_modes=(
        ...
        safety_boundary=("analysis remains educational and decision-supportive; it does not become tasking, targeting, covert collection, or policy advocacy"),
        source_pack_ids=("cia_analytic_uncertainty", "cia_intelligence_profession"),
    ),
    IntelligenceProfile(
        ...
        conceptual_focus=(
            "aligning AI-enabled intelligence with lawful purpose, human accountability, data provenance, bias mitigation, records management, privacy, civil liberties, and periodic review"
        ),
        method_stack=(
            "authority and purpose review, model/data provenance cards, bias and accuracy assessment, human-accountability assignment, lifecycle documentation, and civil-liberties escalation"
        ),
        composability_contract=("data, model, prompt, output, evaluator, accountable human, audit evidence, and retention rule are independently inspectable and versioned"),
        failure_modes=("ethics slogans without controls, undocumented model drift, hidden training-data limits, unowned AI outputs, civil-liberties blind spots, and unreviewed downstream reuse"),
        safety_boundary=("AI governance content uses synthetic or public examples and remains review-oriented; it does not authorize surveillance, targeting, or automated adverse action"),
    ...
    IntelligenceProfile(
        ...
        match_terms=("ageint", "agentic", "ai agent", "mcp", "autogen", "crewai", "langchain", "langgraph", "framework", "python"),
        anchor_keys=(
        ...
        conceptual_focus=("delegated action under explicit authority, identity, permissions, tool boundaries, monitoring, and human escalation"),
        method_stack=("AI RMF Govern-Map-Measure-Manage, least-privilege tool design, prompt-injection review, progressive deployment, and rollback drills"),
        composability_contract=("agents, tools, credentials, memory, retrieval stores, policies, and logs remain separately inspectable and revocable components"),
        failure_modes=("excessive agency, shadow tools, indirect prompt injection, memory poisoning, confused authority, and unbounded action chains"),
        safety_boundary=("agentic workflows stay synthetic, owned-lab, supervised, logged, rate-limited, and reversible unless a lawful production authority exists"),
        source_pack_ids=("cia_ai_analysis_and_production", "ic_cyber_geoint_history", "odni_privacy_oversight"),
    ),
    IntelligenceProfile(
        identifier="osint_geoint",
        title="Open-Source and Geospatial Intelligence Integrity",
        match_terms=("osint", "open-source", "geoint", "imagery", "imint", "source"),
        anchor_keys=(
        ...
        conceptual_focus=("public-source discovery converted into accountable intelligence through provenance, corroboration, minimization, and relevance tests"),
        method_stack=("source triage, provenance capture, corroboration matrix, recency audit, geospatial context review, and confidence calibration"),
        composability_contract=("collection notes, source metadata, transformations, caveats, and analytic judgments remain separately exportable"),
        failure_modes=("privacy drift, stale data, context collapse, platform bias, over-collection, and mistaking availability for reliability"),
        safety_boundary=("OSINT work uses lawful public, owned-lab, or explicitly approved sources and avoids doxxing, harassment, live tracking, or operational targeting"),
        source_pack_ids=("dia_osint_governance", "ic_cyber_geoint_history"),
    ),
    IntelligenceProfile(
        identifier="collection_management",
        title="Collection Management and Multi-INT Requirements Discipline",
        match_terms=("collection", "requirements", "sigint", "masint", "humint", "agent recruitment", "agent handling", "source protection", "emanations", "electronic", "imagery"),
        anchor_keys=(
            "official_intelligence_gov_how_ic_works",
            "official_odni_icd_204",
        ...
        conceptual_focus=("requirements-driven, authority-bounded collection where priorities, legal basis, minimization, source protection, and evaluation are explicit"),
        method_stack=("priority mapping, requirement decomposition, source-discipline fit, coverage-gap review, legal-authority check, and collection-feedback loop"),
        composability_contract=("requirements, authorities, source disciplines, collection notes, retention limits, caveats, and evaluation metrics remain separable"),
        failure_modes=("opportunistic collection, priority drift, over-collection, weak minimization, source exposure, and confusing availability with authority"),
        safety_boundary=("collection material remains doctrinal and governance-oriented; it does not teach recruitment, interception, surveillance, or tasking procedures"),
        source_pack_ids=("odni_governance_directives", "odni_disclosure_and_tearlines"),
    ),
)
