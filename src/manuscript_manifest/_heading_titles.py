...
def chapter_landmark_titles(chapter_title: str, *, profile_title: str = "", practice_lens_title: str = "") -> dict[str, str]:
...
def chapter_scaffold_titles(chapter_title: str) -> dict[str, str]:
    ...
    title = chapter_title.strip()
    return {
        "orientation": (f"{title} orientation: reader task, conceptual primer, outcomes, and vocabulary"),
        "practice": (f"{title} practice studio: topic lessons, safe worked example, and knowledge check"),
        "evidence": (f"{title} evidence contract: source spine, verified anchors, transfer architecture, and claim limits"),
        "governance": (f"{title} governance boundary: synthesis, agent-assistance rules, rights, and assurance gates"),
        "assessment": (f"{title} assessment route: capstone artifacts, refresh duties, reviewer challenges, and handoff"),
    }
...
def chapter_detail_titles(chapter_title: str) -> dict[str, str]:
    ...
    return {
        ...
        "subsection_contract": (f"{title} reusable subsection contract: topic rows, artifacts, and safety duties"),
        ...
        "evidence_standard": (f"{title} evidence standard and citation floor: source families and discovery limits"),
        ...
        "current_source": (f"{title} current-source assurance: verified anchors and local artifact fit"),
...
__all__ = ["chapter_detail_titles", "chapter_landmark_titles", "chapter_scaffold_titles", "chapter_teaching_titles"]
