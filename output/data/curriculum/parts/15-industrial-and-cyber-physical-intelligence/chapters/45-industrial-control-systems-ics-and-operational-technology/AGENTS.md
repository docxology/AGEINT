# AGENTS.md — `45-industrial-control-systems-ics-and-operational-technology` (chapter data)

GENERATED. One chapter of the AGEINT curriculum.
...
## Gotchas
- Generated — do not hand-edit; edit the source tree under `data/curriculum/`.
